...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__225460C",
    appName: "ceping-frontend",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/cepingDetail/cepingDetail",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/alteruser/alteruser",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
